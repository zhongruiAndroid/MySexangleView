...
public class SexangleView2 extends View {
    ...
    public SexangleView2(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public SexangleView2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initPoint() {
        ...
        if(direction==1){
            ...
            */
            ...
            /*添加第1条弧的右半部分*/
            newPath.addArc(arcRect[0],-90,30);
            oldPath.addPath(newPath);
            /*添加第1条线段*/
            newPath.moveTo(lineList.get(0)[0],lineList.get(0)[1]);
            newPath.lineTo(lineList.get(0)[2],lineList.get(0)[3]);
            oldPath.addPath(newPath);

            /*添加第2条弧*/
            newPath.addArc(arcRect[1],-60,60);
            oldPath.addPath(newPath);
            /*添加第2条线段*/
            newPath.moveTo(lineList.get(1)[0],lineList.get(1)[1]);
            newPath.lineTo(lineList.get(1)[2],lineList.get(1)[3]);
            oldPath.addPath(newPath);

            /*添加第3条弧*/
            newPath.addArc(arcRect[2],0,60);
            oldPath.addPath(newPath);
            /*添加第3条线段*/
            newPath.moveTo(lineList.get(2)[0],lineList.get(2)[1]);
            newPath.lineTo(lineList.get(2)[2],lineList.get(2)[3]);
            oldPath.addPath(newPath);

            /*添加第4条弧*/
            newPath.addArc(arcRect[3],60,60);
            oldPath.addPath(newPath);
            /*添加第4条线段*/
            newPath.moveTo(lineList.get(3)[0],lineList.get(3)[1]);
            newPath.lineTo(lineList.get(3)[2],lineList.get(3)[3]);
            oldPath.addPath(newPath);

            /*添加第5条弧*/
            newPath.addArc(arcRect[4],120,60);
            oldPath.addPath(newPath);
            /*添加第5条线段*/
            newPath.moveTo(lineList.get(4)[0],lineList.get(4)[1]);
            newPath.lineTo(lineList.get(4)[2],lineList.get(4)[3]);
            oldPath.addPath(newPath);

            /*添加第6条弧*/
            newPath.addArc(arcRect[5],180,60);
            oldPath.addPath(newPath);
            /*添加第6条线段*/
            newPath.moveTo(lineList.get(5)[0],lineList.get(5)[1]);
            newPath.lineTo(lineList.get(5)[2],lineList.get(5)[3]);
            oldPath.addPath(newPath);

            /*添加第1条弧的左半部分*/
            newPath.addArc(arcRect[0],-120,30);
            oldPath.addPath(newPath);
